module Jekyll
  class PortfolioIndex < Page
    def initialize(site, base, dir)
      ...
      self.process(@name)
      self.read_yaml(File.join(base, '_layouts'), '../work/index.html')
  ...
  class GeneratePortfolio < Generator
    ...
    def write_portfolio_index(site)
      portfolio = PortfolioIndex.new(site, site.source, "/work")
    ...
    def write_project_index(site, path, name)
      project = ProjectIndex.new(site, site.source, "/work/#{name}", path)
